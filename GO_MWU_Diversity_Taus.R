...
mydata=read.csv("Diversity_Taus_GOMWU.csv")
write.csv(mydata, file = "new_Diversity_Taus_GOMWU.csv", append = FALSE, quote = FALSE, sep = " ",
          eol = "\n", na = "NA", dec = ".", row.names = FALSE,
          col.names = FALSE, qmethod = c("escape", "double"),
          fileEncoding = "")

# Edit these to match your data file names: 
input="new_Diversity_Taus_GOMWU.csv" 
